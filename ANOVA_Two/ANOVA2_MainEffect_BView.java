...
public class ANOVA2_MainEffect_BView extends Region { 
    ...
    double  initial_yMin, initial_yMax, initial_yRange, yMin, yMax, yRange,
            ...
            tempPos0, tempPos1, text1Width, text2Width, daMiddleXPosition, 
    ...
    String graphsCSS, strTitle1, strTitle2, strResponseVar, strTitle,
           strFactorA, strFactorB;
    ObservableList<String> categoryLabels, factorA_Levels, factorB_Levels,
                           preStrTopLabels, preStrLeftLabels,
                           strTopLabels, strLeftLabels;
    ...
    // FX Objects
    AnchorPane mainEffectB_AnchorPane, anchorTitleInfo;
    Canvas anova2Canvas;
    CategoryAxis xAxis;
    Pane containingPane;

    ANOVA2_MainEffect_BView(ANOVA2_Model anova2_Model, 
        ...
        preStrTopLabels = anova2_Model.getFactorBLevels();
        preStrLeftLabels = anova2_Model.getFactorALevels();
    ...
    private void setUpAnchorPane() {
        ...
        mainEffectB_AnchorPane = dragableAnchorPane.getTheAP();
    ...
    public void doThePlot() {
        ...
        */      
        ...
        tempPos1 = xAxis.getDisplayPosition(factorB_Levels.get(1));      
        tempPos0 = xAxis.getDisplayPosition(factorB_Levels.get(0));      
        ...
        {
            daMiddleXPosition = xAxis.getDisplayPosition(factorB_Levels.get(theBetweenBatch));
            int theAppropriateLevel = theBetweenBatch;
            tempUCDO = anova2_Model.getPrelimB().getIthUCDO(theAppropriateLevel);   
    ...
    private void initializeGraphParams() { 
        ...
        ****************************************************************/
        ...
        xAxis.setLabel(anova2_Model.getFactorBLabel());
