...
public class ANOVA2_ResidualsView extends Region { 
    ...
    ANOVA2_ResidualsView(ANOVA2_Model anova2_Model, String choiceOfPlot) {
        ...
        for (int theBetweenBatch = 1; theBetweenBatch <= nFactorA_Levels; theBetweenBatch++)
        {
            for (int theWithinBatch = 1; theWithinBatch <= nFactorB_Levels; theWithinBatch++) {
                ...
                */
                ...
                double yy = yAxis.getDisplayPosition(tempResVsFitNDV.getIthDataPtAsDouble(resPoint));
