...
import genericClasses.CoordPairOfIntegers;

public class Splat_EnterHandler {
    ...
    public Splat_EnterHandler( PositionTracker tracker, Splat_DataGrid dg, Splat_DataManager dm) {
