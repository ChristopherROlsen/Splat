...
public class MainMenu extends MenuBar {
    ...
    MainMenu(Application splat, Data_Manager dm, Label fileLabel) {
        ...
        MenuItem anova_CRD = new MenuItem("One-Factor ANOVA: "
                + "Completely Randomized Design");
        MenuItem anova_Trend = new MenuItem("One-Factor ANOVA: "
                + "Trend analysis");
        ...
        MenuItem runRepeatedanova = new MenuItem("Repeated measures ANOVA for "
                + "One variable");
        anova.getItems().addAll(anova_CRD, anova_Trend, runRCBanova, runCR2anova, runRepeatedanova);
        ...
        anova_CRD.setOnAction((ActionEvent event) -> {
            ANOVA1_Procedure anova1_Proc = new ANOVA1_Categorical_Procedure(dm);
            anova1_Proc.doStackedOrNot();
            returnStatus = anova1_Proc.getReturnStatus(); 
        });
        
        anova_Trend.setOnAction((ActionEvent event) -> {
            QANOVA1_Quant_Procedure anova1_Proc = new QANOVA1_Quant_Procedure(dm);
            anova1_Proc.doStackedOrNot();
            returnStatus = anova1_Proc.getReturnStatus(); 
        });
