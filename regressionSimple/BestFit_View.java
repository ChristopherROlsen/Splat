...
public class BestFit_View extends Scatterplot_W_CheckBoxes_View
{
    // POJOs
    ...
    public BestFit_View(Regression_Model regModel, Simple_Regression_Dashboard regDashboard,
        ...
        //System.out.println("75 bf, 1 / nDataPoints = " + nDataPoints);
        //System.out.println("76 bf, fInfluence/Trigger = " + fInfluence + " / " + influenceTrigger);
    ...
    {      
        ...
        for (int i = 0; i < nDataPoints; i++)
        {
            ...
            if (outlierPlotDesired == true) {
                ...
                double outDiameter = 3.0 * outRadius;
            ...
            if (influencePlotDesired == true) {
                ...
                // System.out.println("185 bf, cooksD = " + cooksD);
