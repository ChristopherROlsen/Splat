...
public class Simple_Regression_Dashboard extends Dashboard {
    // POJOs
    String subTitle;
    ...
    public Simple_Regression_Dashboard(Regression_Procedure regression_Procedure, Regression_Model regression_Model) {
        super(6);  // nCheckBoxes = 6.  Hard coded b/c super must be first statement
        ...
        subTitle = regression_Procedure.getSubTitle();
    ...
    public void populateTheBackGround() {
        //   In the Dashboard superclass, initial widths are 675, initial heights are 375
