...
public class OneMean_SummaryStats_Dialog extends Stage { 
    ...
    public OneMean_SummaryStats_Dialog() {
...
private void makeNullsPanel() {
    ...
    private void makeNumericValuesPanel() {
        ...
        stf_N1.getTextField().setOnAction(e -> {
            bool_N1Good = DataUtilities.stringIsAPositiveInteger(stf_N1.getTextField().getText());
            if (bool_N1Good == true) {
        ...
        stf_Mean2.getTextField().setOnAction(e -> {
            bool_Mean2Good = DataUtilities.textFieldHasDouble(stf_Mean1.getTextField());
        ...
        stf_N2.getTextField().setOnAction(e -> {
            bool_N2Good = DataUtilities.stringIsAPositiveInteger(stf_N2.getTextField().getText());
            if (bool_N2Good == true) {
    ...
    private void makeBottomPanel() {        
        ...
        bool_Sigma1Good = StringUtilities.check4PosReal(stf_Sigma1.getTextField().getText());
        bool_Sigma2Good = StringUtilities.check4PosReal(stf_Sigma2.getTextField().getText());
