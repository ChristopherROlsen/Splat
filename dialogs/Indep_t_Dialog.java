...
public class Indep_t_Dialog extends Two_Variables_Dialog{ 
    ...
    double hypothesizedDifference, currentSigLevel, currentConfLevel, 
           daNullDiff, alpha;
    ...
    HBox alphaAndCI, nullDiffInfo, hBoxCurrDiff;
    VBox ciBox, alphaBox;
 ...
 public void makeHypotheses() {
        ...
        changeNull.setOnAction((ActionEvent event) -> {
            ...
            // System.out.println("daNewNullDiff = " + hypothesizedDifference);
        });
    }
