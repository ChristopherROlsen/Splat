...
public class ResidsVsFit_View extends Scatterplot_View
{
    // POJOs
    ...
    Pane residsVsFitsContainingPane;

    public ResidsVsFit_View(MultRegression_Model multRegModel, MultRegression_Dashboard multRegDashboard,
                        double placeHoriz, double placeVert,
                        double withThisWidth, double withThisHeight) {
        
        super(placeHoriz, placeVert, withThisWidth, withThisHeight);
        nRows = multRegModel.getNRows();
        Fits = new Matrix(nRows, 1);
        Fits = multRegModel.getYHats();
        ...
        residsVsFitsCheckBoxDescr[0] = " Horizontal line ";
    ...
    private void constructDataArray()
    {
        ...
        xDataMin = xDataMax = Fits.get(0, 0);
        yDataMin = yDataMax = R_Student.get(0, 0);
        
        for (int iRow = 0; iRow < nRows; iRow++)
        {
            double tempDoubleX = Fits.get(iRow, 0);
            double tempDoubleY = R_Student.get(iRow, 0);
    ...
    {      
        ...
        for (int i = 0; i < nRows; i++)
        {
            ...
            if (influencePlotDesired == true) {
                ...
                gc.setLineWidth(2);
                double rStudent = R_Student.get(i, 0);
